...
class SSVEP{
	...
	createSetupUI(){
		...
		for (let i=0; i<this.boxesCount; i++) {
			$(this.setupUIElem).find("div.setupTable").find("tbody").append('<tr><td>'+(i+1)+'</td><td><input type="text" name="freq" value="'+(8+i*0.6)+'"></td><td><input type="text" name="text" value="'+String.fromCharCode("A".charCodeAt(0)+i)+'"></td><td><div class="removeBtn"></div></td></tr>');
		}
		// Bind button callbacks
		$(this.setupUIElem).find(".addBtn").click(() => {
			const i = $(this.setupUIElem).find("div.setupTable").find("tbody").find("tr").size();
			$(this.setupUIElem).find("div.setupTable").find("tbody").append('<tr><td>'+(i+1)+'</td><td><input type="text" name="freq" value="'+(8+i*0.3)+'"></td><td><input type="text" name="text" value="'+String.fromCharCode("A".charCodeAt(0)+i)+'"></td><td><div class="removeBtn"></div></td></tr>');
